...
import 'package:ticketeer/widgets/thick_container.dart';
...
class TicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      height: AppLayout.getHeight(GetPlatform.isAndroid == true ? 160 : 200),
      child: Container(
        margin: EdgeInsets.only(right: AppLayout.getHeight(16)),
        child: Column(
          children: [
            //  showing the blue part of our ticket a lot
            Container(
